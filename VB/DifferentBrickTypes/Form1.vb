...
Namespace DifferentBrickTypes
    ...
    Public Partial Class Form1
        ...
        Private Sub simpleButton1_Click(ByVal sender As Object, ByVal e As EventArgs)
            ...
            Dim printingSystem As PrintingSystem = New PrintingSystem()
        ...
        Private Sub Link_CreateDetailArea(ByVal sender As Object, ByVal e As CreateAreaEventArgs)
            ...
            Dim format As BrickStringFormat = New BrickStringFormat(StringAlignment.Near, StringAlignment.Center)
            ...
            For i As Integer = 0 To 5 - 1
                ...
                If i < 2 Then textBrick.StringFormat = textBrick.StringFormat.ChangeAlignment(StringAlignment.Far)
            Next
        ...
        Private Sub Link_CreateMarginalHeaderArea(ByVal sender As Object, ByVal e As CreateAreaEventArgs)
            ...
            Dim size As SizeF = brickGraphics.MeasureString(devexpress)
